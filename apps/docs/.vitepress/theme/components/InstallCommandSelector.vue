...
<template>
  ...
  >
    <label
      for="pkg-manager"
      class="mb-2 block text-sm font-semibold text-[color:var(--vp-c-text-1)]"
    >
      {{ t.label }}
    </label>
    <select
      id="pkg-manager"
      v-model="manager"
      class="w-full border border-[color:var(--vp-c-bg-alt)] bg-[color:var(--vp-c-bg)] px-3 py-2 text-sm text-[color:var(--vp-c-text-1)]"
    >
    ...
    <div
      class="mt-3 border border-[color:var(--vp-c-bg-alt)] bg-[color:var(--vp-code-bg)] p-3"
    >
