  ...
  <Teleport to="body">
    ...
    <Transition name="menu-drawer">
      ...
      >
        <!-- Drawer header -->
        <div
          class="flex items-center justify-between border-b border-[color:var(--vp-c-bg-alt)] px-5 py-4 dark:border-[#1f1f1f]"
        >
          <span
            class="font-heading text-sm font-semibold tracking-wide text-[color:var(--vp-c-text-1)]"
            >contract-kit</span
          >
          <button
            type="button"
        ...
        <!-- Lang switch -->
        <div
          class="border-t border-[color:var(--vp-c-bg-alt)] px-5 py-4 dark:border-[#1f1f1f]"
        >
          <p
            class="mb-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-[color:var(--vp-c-text-3)]"
          >
            Language
          </p>
